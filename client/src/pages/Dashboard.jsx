...
function Dashboard() {
  ...
  // Here we use useEffect to show managejob on dashboard
  useEffect(() => {
    if (companyData) {
    ...
    <div className='min-h-screen'>
      ...
      <div className='shadow py-4'>
        <div className='px-5 flex justify-between items-center'>
          <img onClick={() => navigate('/')} className='ml-16 size-3/12 sm:size-2/12 md:size-1/12 cursor-pointer' src={assets.logo} alt="" />
          {companyData &&
            (
